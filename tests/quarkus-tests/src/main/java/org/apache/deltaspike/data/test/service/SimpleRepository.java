...
public interface SimpleRepository extends EntityRepository<Simple, Long> {
    ...
    // FIXME: naming convention based queries, non-trivial conversion
    @Find
    ...
    @Find
    Simple findOptionalByName(String name);
    ...
    void removeByNameAndEnabled(String name, Boolean aTrue);
